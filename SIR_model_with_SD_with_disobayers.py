...
class pandemic_model_with_SD_and_disobay:
    def __init__(self,N,P_tansmition,R_transmition,duration,SD_threshold,SD_tics,P_disobay):
        ...
        self.disobay_array=ran.choice([0,1],self.num_agents\
                                      ,p=[1-P_disobay,P_disobay])
        print(self.disobay_array)
    ...
    def social_distence_correction(self):
        ...
        self.forces_x=forces*X_rasio*(1-self.disobay_array)+\
            ran.randn(self.num_agents)*0.0001
        self.forces_y=forces*Y_rasio*(1-self.disobay_array)\
            +ran.randn(self.num_agents)*0.0001
    ...
    def run_sim(self,num_of_tics):
        ...
        for t in range(num_of_tics):
            ...
            if SD==True and SD_time<=self.SD_length:
                self.volositis_x=self.volositis_x*self.disobay_array
                self.volositis_y=self.volositis_y*self.disobay_array
